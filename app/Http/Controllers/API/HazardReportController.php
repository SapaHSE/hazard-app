...
class HazardReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'reported_department' => 'nullable|string|max:255',
            'hazard_category'     => 'nullable|string|max:255',
            'hazard_subcategory'  => 'nullable|string|max:255',
            'suggestion'          => 'nullable|string',
            'pelaku_pelanggaran'  => 'nullable|string|max:255',
            'pelapor_location'    => 'nullable|string|max:255',
            'kejadian_location'   => 'nullable|string|max:255',
